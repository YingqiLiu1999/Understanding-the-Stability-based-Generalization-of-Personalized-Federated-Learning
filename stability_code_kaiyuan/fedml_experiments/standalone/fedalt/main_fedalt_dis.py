...
from fedml_api.standalone.fedalt_dis.fedalt_dis_api import FedAltAPI
from fedml_api.standalone.fedalt_dis.my_model_trainer import MyModelTrainer
...
if __name__ == "__main__":
    ...
    parser = add_args(argparse.ArgumentParser(description='FedAlt-standalone'))
    ...
    for exper_index in range(args.num_experiments):
        ...
        args.identity = "fedalt_dis"  + "-"+data_partition
        ...
        fedAltAPI = FedAltAPI(dataset1,dataset2,dataset3, device, args, model_trainer, logger)

        train_loss_result, test_loss_result, distance_weight_result , test_acc_result = fedAltAPI.train()
